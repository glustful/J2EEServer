package com.dunbian.jujiabao.alipay.util;
...
import com.dunbian.jujiabao.alipay.sign.MD5;
import com.dunbian.jujiabao.alipay.sign.RSA;
import com.dunbian.jujiabao.alipay.util.httpClient.HttpProtocolHandler;
import com.dunbian.jujiabao.alipay.util.httpClient.HttpRequest;
import com.dunbian.jujiabao.alipay.util.httpClient.HttpResponse;
import com.dunbian.jujiabao.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @return 签名结果字符串
     */
	public static String buildRequestMysign(Map<String, String> sPara, String singType) {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp, String signType) {
        ...
        System.err.println("##############***buildRequestMysign**MD5:"+(end-start));
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String signType, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        //待请求参数数组
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String signType, Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp, signType);
        List<String> keys = new ArrayList<String>(sPara.keySet());
     ...
     * @throws Exception
     */
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String signType, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
    	long start = System.currentTimeMillis();
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp, signType);
        long end = System.currentTimeMillis();
        System.err.println("############buildRequestPara:"+(end-start));
