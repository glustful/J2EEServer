...
public class AlipayNotify {
    ...
    public static boolean verifyReturn(Map<String, String> params) {
	    ...
	    //验证签名
	    boolean isSign = getWapSignVeryfy(params, sign, true);
     ...
     * @return 验证结果
     */
    public static boolean verifyWapNotify(Map<String, String> params) throws Exception {
     ...
     * @return 生成的签名结果
     */
	private static boolean getWapSignVeryfy(Map<String, String> Params, String sign, boolean isSort) {
    ...
    */
    ...
    public static boolean verify(Map<String, String> params) {
	    ...
	    String sign = "";
	    if(params.get("sign") != null) {sign = params.get("sign");}
	    boolean isSign = getWebSignVeryfy(params, sign);
...
//	    AlipayCore.logResult(sWord);
     ...
     * @return 生成的签名结果
     */
	private static boolean getWebSignVeryfy(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
        ...
        if(AlipayConfig.web_sign_type.equals("MD5") ) {
        	isSign = MD5.verify(preSignStr, sign, AlipayConfig.key, AlipayConfig.input_charset);
        }else if(AlipayConfig.web_sign_type.equals("0001")){
        	isSign = RSA.verify(preSignStr, sign, AlipayConfig.ali_public_key, AlipayConfig.input_charset);
        }
        return isSign;
    }
